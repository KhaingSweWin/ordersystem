		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Customers</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="offices.php">
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Offices</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="square"></i> <span class="align-middle">Product Lines</span>
            </a>
					</li>
